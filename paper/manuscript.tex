...
The topic-level comparison to \citet{mahieu2022ifc} uses mapped descriptor families and driver strengths extracted from the published paper and processed notes. It should be interpreted as a structural validation of modality and topic order, not as an exact re-estimation of every descriptor coefficient.
